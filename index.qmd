...
[^1]: See [https://en.wikipedia.org/wiki/GSM#Initial_European_development](https://en.wikipedia.org/wiki/GSM#Initial_European_development).
[^2]: https://build.fhir.org/ig/FHIR/sql-on-fhir-v2/
[^3]: FHIR: [https://confluence.hl7.org/display/FHIR/Open+Source+Implementations](https://confluence.hl7.org/display/FHIR/Open+Source+Implementations). OMOP: [https://www.ohdsi.org/software-tools/](https://www.ohdsi.org/software-tools/). OpenEHR: [https://openehr.org/products_tools/platform/](https://openehr.org/products_tools/platform/)
[^4]: https://deltaplus.azdelta.be/az-delta30/zorginnovatie
[^5]: https://omoponfhir.org
[^6]: See [https://arrow.apache.org](https://arrow.apache.org), [https://parquet.apache.org](https://parquet.apache.org) and [https://iceberg.apache.org](https://iceberg.apache.org)
[^7]: [https://hapifhir.io](https://hapifhir.io)
[^8]: [https://getdbt.com](https://getdbt.com)
[^9]: [https://www.getdbt.com/](https://www.getdbt.com/)
[^10]: [https://jembi.gitbook.io/instant-v2](https://jembi.gitbook.io/instant-v2)
